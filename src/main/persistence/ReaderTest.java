...
class ReaderTest {
    ...
    void testParsePlaylistsTestFile() {
        try {
            ...
            assertEquals("Country Thunder", p1.getPlaylistName());
            assertEquals("Country", p1.getPlaylistGenre());
            assertEquals("1", p1.getTotalSongs());
            assertEquals("250", p1.getTotalRuntime());
